...
export default function Profile({navigation}) {
  ...
  const [userScrore, setUserScrore] = useState(null);
  ...
  const getHistory = async id => {
    await axios
      ...
      .then(res => {
        setUserScrore(res.data?.totalScore);
        // console.log('res', res.data.totalScore);
      })
        ...
        <ScrollView>
          ...
          <View style={{margin: '20%'}}>
            <Text body1 style={{textAlign: 'center'}}>
             Total Score is: {userScrore?userScrore:'0'}
            </Text>
            <Text body1 style={{textAlign: 'center'}}>
              Care APP V 0.1{' '}
            </Text>
